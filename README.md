...
To properly clone and work with this repository, please follow these steps:

1. **Install Git LFS**  
   Download and install Git LFS from [https://git-lfs.github.com/](https://git-lfs.github.com/)

2. **Initialize Git LFS** (only needed once per system)
   ```bash
   git lfs install
...
```
cd existing_repo
git remote add origin https://code.ovgu.de/dschott/virtual-intervention-room.git
git branch -M main
...
- [ ] [Set up project integrations](https://code.ovgu.de/dschott/virtual-intervention-room/-/settings/integrations)
