...
public class HierarchyObjectColor
{
    ...
    private static void HandleHierarchyWindowItemOnGUI(int instanceID, Rect selectionRect)
    {
        ...
        if (obj != null)
        {
            ...
            if (obj.name == "2D-Program")
            {
                backgroundColor = new Color(0.1f, 0.4f, 0.05f);
            ...
            if (obj.name == "SlideControl")
            {
                backgroundColor = new Color(0.2f, 0.5f, 0.1f);
                textColor = new Color(0.9f, 0.9f, 0.9f);
            }
            if (obj.name == "Surgical_Gloves_v06_left")
            {
                backgroundColor = new Color(0.8f, 0.8f, 0.8f);
                textColor = new Color(0.2f, 0.2f, 0.2f);
            }
            if (obj.name == "Surgical_Gloves_v06_right")
            {
                backgroundColor = new Color(0.8f, 0.8f, 0.8f);
                textColor = new Color(0.2f, 0.2f, 0.2f);
            }
